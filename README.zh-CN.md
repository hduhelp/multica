...
[官网](https://multica.hduhelp.com) · [云服务](https://multica.hduhelp.com) · [Discord](https://discord.gg/W8gYBn226t) · [X](https://x.com/MulticaAI) · [自部署指南](SELF_HOSTING.md) · [参与贡献](CONTRIBUTING.md)
...
后续可用 `brew upgrade hduhelp/tap/multica` 更新 CLI。
...
安装好 CLI（或注册 [Multica 云服务](https://multica.hduhelp.com)）后，按以下步骤将第一个任务分配给 Agent：
