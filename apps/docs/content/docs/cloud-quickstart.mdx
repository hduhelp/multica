...
Sign in on the web ([multica.hduhelp.com](https://multica.hduhelp.com)) or with [Multica Desktop](https://multica.hduhelp.com/download). Email verification codes and Google are both supported.
