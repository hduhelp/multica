...
// Convention: api hosts are exposed at `api.<web-host>` (multica.api.hduhelp.com →
// multica.hduhelp.com, api.test.multica.hduhelp.com → test.multica.hduhelp.com). Strip the leading
