...
import { CLI_INSTALL_COMMANDS } from "../../common/cli-install-command";
...
// Read from the shared source: a restated URL drifts whenever the
// install source changes, which is what broke this test once already.
...
describe("ConnectRemoteDialog", () => {
  ...
  it("uses cloud setup commands by default", () => {
    ...
    expect(baseElement).toHaveTextContent(
      "multica config set server_url https://multica.api.hduhelp.com",
    );
    expect(baseElement).toHaveTextContent(
      "multica config set app_url https://multica.hduhelp.com",
    );
  });
