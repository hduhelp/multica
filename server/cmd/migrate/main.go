...
var concurrentIndexCleanups = map[string]string{
	...
	"9003_agent_fixed_repo_lock_active_path_index":              "idx_agent_fixed_repo_lock_active_path",
	"9004_agent_fixed_repo_lock_active_task_index":              "idx_agent_fixed_repo_lock_active_task",
