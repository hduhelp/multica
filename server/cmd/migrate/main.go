...
var concurrentIndexCleanups = map[string]string{
	...
	"434_agent_fixed_repo_lock_active_path_index":               "idx_agent_fixed_repo_lock_active_path",
	"435_agent_fixed_repo_lock_active_task_index":               "idx_agent_fixed_repo_lock_active_task",
