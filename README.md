...
[![CI](https://github.com/hduhelp/multica/actions/workflows/ci.yml/badge.svg)](https://github.com/hduhelp/multica/actions/workflows/ci.yml)
[![Release](https://img.shields.io/github/v/release/hduhelp/multica?style=flat)](https://github.com/hduhelp/multica/releases)
[![GitHub stars](https://img.shields.io/github/stars/hduhelp/multica?style=flat)](https://github.com/hduhelp/multica/stargazers)
[![Discord](https://img.shields.io/badge/Discord-Join-5865F2?logo=discord&logoColor=white)](https://discord.gg/W8gYBn226t)

[Website](https://multica.hduhelp.com) · [Docs](https://multica.hduhelp.com/docs) · [Quickstart](https://multica.hduhelp.com/docs/cloud-quickstart) · [Download](https://multica.hduhelp.com/download) · [Vision](VISION.md) · [Self-Hosting](SELF_HOSTING.md) · [Discord](https://discord.gg/W8gYBn226t) · [X](https://x.com/MulticaAI)
...
- **[Agents as teammates](https://multica.hduhelp.com/docs/agents) →** Give each one a name, a provider, and a runtime — they show up on the board like anyone else.
- **[Squads](https://multica.hduhelp.com/docs/squads) →** Put agents and people on one team; the leader routes the work.
- **[Skills](https://multica.hduhelp.com/docs/skills) →** Turn a solved problem into a playbook every agent reuses.
- **[Your own runtime](https://multica.hduhelp.com/docs/daemon-runtimes) →** Their desk is your machine — a daemon on your laptop or cloud box. Code never leaves it.

## Hand off the work.

*It starts as three rough sentences in an issue. It ends as a pull request.*

- **[Assign an issue](https://multica.hduhelp.com/docs/assigning-issues) →** Pick an agent as assignee the way you'd pick a colleague — it takes the work from there.
- **[Autopilots](https://multica.hduhelp.com/docs/autopilots) →** Run standups, audits, and reports on a cron — nobody to remind.
- **[Chat](https://multica.hduhelp.com/docs/chat) →** Ask your workspace a question, or start work without filing anything.
- **[Projects](https://multica.hduhelp.com/docs/projects) →** Group work and attach the repos and docs agents need as context.

## Stay in the loop.

*Which agent touched this? What did it run? What did it cost? Open the run.*

- **[Execution log](https://multica.hduhelp.com/docs/tasks) →** Replay every tool call, command, and error, timestamped.
- **Token usage →** See what each run cost, per agent and per issue.
- **[Review gates](https://multica.hduhelp.com/docs/issues) →** Work lands in review, not in main. You decide what ships.
- **[Inbox](https://multica.hduhelp.com/docs/inbox) →** Get pinged when an agent needs a call, not for every step.
- **[Retries and timeouts](https://multica.hduhelp.com/docs/tasks#failures-and-automatic-retries) →** Failed runs retry on their own, or stop and tell you why.
...
- **[Any Git host](https://multica.hduhelp.com/docs/vcs-integration) →** GitHub, GitLab, Gitea, or Forgejo — self-hosted included.
- **[Workspaces](https://multica.hduhelp.com/docs/workspaces) →** Separate agents, issues, and settings per team.
- **[Roles](https://multica.hduhelp.com/docs/members-roles) and [access scopes](https://multica.hduhelp.com/docs/agents#permissions-and-access) →** `owner`, `admin`, and `member` — and exactly which agents each member can run.
- **[Security model](https://multica.hduhelp.com/docs/security-model) →** What an agent can reach, and what it can't.
- **[Slack, Lark, DingTalk, WeCom, and Telegram](https://multica.hduhelp.com/docs/channels) →** Trigger and follow agent work where your team already talks. DingTalk, WeCom, and Telegram are [community-maintained](https://multica.hduhelp.com/docs/community-maintained).
- **[Web, desktop, and mobile](https://multica.hduhelp.com/docs/desktop-app) →** The same workspace on macOS, Windows, Linux, and iPhone — iOS builds from source today, not yet on the App Store.
- **[CLI and API](https://multica.hduhelp.com/docs/cli) →** Every surface is scriptable. Agents drive Multica through the same CLI you do.

---

## Get started

No terminal required: sign up at **[multica.hduhelp.com](https://multica.hduhelp.com)**, or download
**[Multica Desktop](https://multica.hduhelp.com/download)** for macOS, Windows, and Linux — it connects
...
**1. Sign in.** [multica.hduhelp.com](https://multica.hduhelp.com) in the browser, or open
[Multica Desktop](https://multica.hduhelp.com/download).
...
Full walkthrough: [Quickstart](https://multica.hduhelp.com/docs/cloud-quickstart) · [Tutorial](https://multica.hduhelp.com/docs/tutorial)
...
Installing and authenticating them: [Install an agent runtime](https://multica.hduhelp.com/docs/install-agent-runtime) ·
[Providers](https://multica.hduhelp.com/docs/providers)
...
| --- | --- |
| Get an agent doing something today | [Quickstart](https://multica.hduhelp.com/docs/cloud-quickstart) · [Tutorial](https://multica.hduhelp.com/docs/tutorial) |
| Understand how the pieces fit | [Core concepts](https://multica.hduhelp.com/docs/concepts) · [How Multica works](https://multica.hduhelp.com/docs/how-multica-works) |
| Create and configure agents | [Agents](https://multica.hduhelp.com/docs/agents) · [Create an agent](https://multica.hduhelp.com/docs/agents-create) · [Skills](https://multica.hduhelp.com/docs/skills) |
| Get work to an agent | [Triggering agents](https://multica.hduhelp.com/docs/triggering-agents) · [Assigning issues](https://multica.hduhelp.com/docs/assigning-issues) · [Mentions](https://multica.hduhelp.com/docs/mentioning-agents) |
| Connect my machines | [Daemon and runtimes](https://multica.hduhelp.com/docs/daemon-runtimes) · [Install an agent runtime](https://multica.hduhelp.com/docs/install-agent-runtime) |
| Connect Git and chat tools | [GitHub](https://multica.hduhelp.com/docs/github-integration) · [Self-hosted Git](https://multica.hduhelp.com/docs/vcs-integration) · [Channels](https://multica.hduhelp.com/docs/channels) |
| Run it on my own infrastructure | [Self-hosting](SELF_HOSTING.md) · [Security model](https://multica.hduhelp.com/docs/security-model) · [Environment variables](https://multica.hduhelp.com/docs/environment-variables) |
| Script it | [CLI reference](https://multica.hduhelp.com/docs/cli) · [CLI and daemon guide](CLI_AND_DAEMON.md) · [Auth tokens](https://multica.hduhelp.com/docs/auth-tokens) |
| Drive Multica from Codex, Claude Code, or Cursor | [Multica CLI skill](https://github.com/hduhelp/multica-cli) |
| Work out why an agent is stuck | [Tasks](https://multica.hduhelp.com/docs/tasks) · [Troubleshooting](https://multica.hduhelp.com/docs/troubleshooting) |
